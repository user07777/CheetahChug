...
public:
    CDraw()
    {
        ...
        g_pIB = NULL;
        int FontNr = 0;
        D3DXCreateFont(pDevice, 14, 0, FW_NORMAL, 1, 0,
            DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, ANTIALIASED_QUALITY, DEFAULT_PITCH, L"Arial", &pFont);;
    }
    ...
    //=============================================================================================
    bool Font();
    void AddFont(const wchar_t* Caption, float size, bool bold, bool italic);
    void FontReset();
    void OnLostDevice();
    //=============================================================================================
